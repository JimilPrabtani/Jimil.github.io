...
<template>
     <FramedMainSection id="Certificates" class="h-dvh">
        <Parallax>
        <div class="h-full w-full relative overflow-hidden rounded-4xl text-white flex justify-center items-center p-4">
